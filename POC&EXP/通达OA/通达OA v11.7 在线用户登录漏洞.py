...
def POC_1(target_url):
    ...
    try:
        requests.packages.urllib3.disable_warnings(InsecureRequestWarning)  # 解决https警告
        response = requests.get(url=vuln_url, headers=headers, verify=False, timeout=5)  # verify ssl认证
